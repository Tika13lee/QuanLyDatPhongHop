...
public interface RequestFormRepository extends JpaRepository<RequestForm, Long> {
    ...
    List<RequestForm> findRequestFormByStatusPending(@Param("statusRequestForm") StatusRequestForm statusRequestForm,
                                                     @Param("typeRequestForm") TypeRequestForm typeRequestForm,
                                                     @Param("dayStart") Date dayStart); @Query("select r from RequestForm r join r.reservations res where res.reservationId = :reservationId and r.statusRequestForm = 'APPROVED' order by r.timeRequest desc ")
